...
Invoke Lint could always use more documentation, whether as part of the
official Invoke Lint docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
Ready to contribute? Here's how to set up `Invoke Lint` for local development.

1. Fork the `invoke-lint` repo on GitHub.
...
[GitHub Issues]: https://github.com/yukihiko-shinoda/invoke-lint/issues
